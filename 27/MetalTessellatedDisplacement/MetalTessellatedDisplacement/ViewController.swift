...
class ViewController: BaseViewController {
    ...
    @IBOutlet weak var displacementFactorSlider: NSSlider!
    ...
    override func viewDidLoad() {
        ...
        cameraController.eye = SIMD3<Float>(0, 4, 4)
    ...
    @IBAction func tessellationFactorDidChange(_ sender: Any) {
        let exponent = tessellationFactorSlider.floatValue
        let factor = powf(2.0, exponent)
        renderer.tessellationFactor = factor
    }

    @IBAction func displacementFactorDidChange(_ sender: Any) {
        let factor = displacementFactorSlider.floatValue
        renderer.displacementFactor = factor
    }
